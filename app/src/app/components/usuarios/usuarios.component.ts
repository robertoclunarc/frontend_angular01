...
export class UsuariosComponent implements OnInit {
    ...
    constructor(
        private servUsuarios: UserService,
        private messageService: MessageService,
        private confirmationService: ConfirmationService,
        private router: Router,
        private srvRolesUsuarios: RolesUsuariosService,
    ...
    eliminarRolesDelUsuario(idUsuario: number) {
        ...
        this.srvRolesUsuarios.getRolesAsignados(idUsuario).subscribe((data) => {
            if (data.length > 0) {
                rolesasig = data;
    ...
    eliminarPerfilesDelUsuario(idUsuario: number, usuario: User) {
        ...
        this.srvPerfilesUsuarios.getPerfilesAsignados(idUsuario).subscribe((data) => {
            if (data.length > 0) {
                perfilesasig = data;
            ...
            this.servUsuarios.eliminarUsuario(usuario).subscribe(
                ...
                (error) => {
                    alert('Usuario con actividad en otros , No se puede eliminar!');
                },
            );
            this.actualizarLista();
        });
    ...
    actualizarLista() {
        //this.Usuarios = [];
        this.servUsuarios.getAll().subscribe((data) => {
            //this.Usuarios = [];
            //this.Usuarios = data;
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                this.servUsuarios.nuevoUsuario(cusuario).subscribe((data) => {
                    ...
                    //Clonado los Roles
                    this.srvRolesUsuarios.getRolesAsignados(idclone).subscribe((data) => {
                ...
                this.messageService.add({
                    key: 'tc',
                    severity: 'success',
                    summary: 'USUARIO Clonado correctamente!!!. La clave por defecto es 1234',
                });
            },
        });
    }
